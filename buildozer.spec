...
# (list) Application requirements - Use Python 3.9.5
requirements = python3==3.9.5,kivy==2.1.0,requests,plyer,pyjnius,android,kivy-garden.xwebview
...
# (str) Android NDK version - Use 25c for develop branch
android.ndk = 25c
